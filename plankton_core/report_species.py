...
class CreateReportSpecies(object):
    ...
    def create_report(
        ...
        # Set header.
        self._numberofcolumns = 8 + (
            self._numberofsamples * self._numberofcolumnspersample
        )
        ...
        header_row_1[7] = "Station:"
        header_row_2[7] = "Sampling date:"
        header_row_3[7] = "Min. depth:"
        header_row_4[7] = "Max. depth:"
        header_row_5[7] = "Analysis date:"
        header_row_6[7] = "Analysed by:"
        #
                ...
                for samplenode in visitnode.get_children():
                    ...
                    for variablenode in samplenode.get_children():
                        ...
                        taxonandsize = (
                            ...
                            + ":"
                            + variablenode.get_data("species_flag_code")
                            + ":"
                            + variablenode.get_data("cf")
                            + ":"
                        ...
                        if self._reporttype == "counted":
                            ...
                            if parameter == "Biovolume concentration":
                                parameter_values_dict[taxonandsize][
                                    sampleindex * self._numberofcolumnspersample + 1
                                ] = value
                        elif self._reporttype == "net":
        ...
        for phytowinnameandsize in parameter_values_dict.keys():
            ...
            harmful = plankton_core.Species().get_taxon_value(scientificname, "harmful")
                ...
                if oldrow:
                    if row[2]:  # Don't aggregate if species is missing.
                        ...
                        if oldrow[2] == row[2]:  # Column 2: Species.
                            if (
                                oldrow[5] == row[5]
                            ):  # Column 5: Trophy may differ for Unicells etc.
                                sampleindex = 0
        ...
        if self._reporttype == "counted":
            if aggregate_rows:
                result_table.append_row(
                    ...
                    + ["Units/L", "Biovolume (mm3/L)"] * self._numberofsamples
            ...
            result_table.append_row(
                ...
                + ["Occurrence"] * self._numberofsamples
            )  # Two columns per sample.
        #
        for row in species_rows:
