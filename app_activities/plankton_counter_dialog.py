...
class PlanktonCounterDialog(QtWidgets.QDialog):
    ...
    def _create_content(self):
        ...
        #
        dataset_sample_label = QtWidgets.QLabel(
            "Dataset: <b>"
    ...
    def _content_metadata(self):
        """ """
        self.metadata_widget = app_activities.PlanktonCounterSampleInfo(
            self,
            self._current_dataset,
            self._current_sample,
    ...
    def _content_methods(self):
        """ """
        self.methods_widget = app_activities.PlanktonCounterSampleMethods(
            self,
            self._current_dataset,
            self._current_sample,
            self._current_sample_object,
    ...
    def _content_count(self):
        """ """
        self.count_widget = app_activities.PlanktonCounterSampleCount(
            self,
            self._current_dataset,
            self._current_sample,
            self._current_sample_object,
    ...
    def _content_sample_data(self):
        """ """
        self.sample_data_widget = app_activities.PlanktonCounterSampleEdit(
            self,
            self._current_dataset,
            self._current_sample,
            self._current_sample_object,
