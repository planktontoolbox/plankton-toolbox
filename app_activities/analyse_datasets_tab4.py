...
#         self._lifestage_listview.setMaximumHeight(100)
        ...
        self.connect(clicklabel1.clicked(self._stations_listview.uncheckAll)                
        self.connect(clicklabel2.clicked(self._stations_listview.checkAll)                
        self.connect(clicklabel3.clicked(self._months_listview.uncheckAll)                
        self.connect(clicklabel4.clicked(self._months_listview.checkAll)                
        self.connect(clicklabel5.clicked(self._visits_listview.uncheckAll)                
        self.connect(clicklabel6.clicked(self._visits_listview.checkAll)                
        self.connect(clicklabel7.clicked(self._minmaxdepth_listview.uncheckAll)                
        self.connect(clicklabel8.clicked(self._minmaxdepth_listview.checkAll)                
        self.connect(clicklabel9.clicked(self._taxon_listview.uncheckAll)                
        self.connect(clicklabel10.clicked(self._taxon_listview.checkAll)                
        self.connect(clicklabel11.clicked(self._trophic_type_listview.uncheckAll)                
        self.connect(clicklabel12.clicked(self._trophic_type_listview.checkAll)                
        self.connect(clicklabel13.clicked(self._lifestage_listview.uncheckAll)                
        self.connect(clicklabel14.clicked(self._lifestage_listview.checkAll)                
        # Layout widgets.
