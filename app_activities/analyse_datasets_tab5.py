...
class AnalyseDatasetsTab5(QtWidgets.QWidget):
    ...
    def content_predefined_graphs(self):
        ...
        self._addplot_3_button = QtWidgets.QPushButton(
            "Values for taxa / station and date"
        )
        self._addplot_3_button.clicked.connect(self._add_plot_3)
        self._addplot_4_button = QtWidgets.QPushButton(
            "Values for station and date / taxa"
        )
    ...
    def _add_plot_1(self, subplot_only=False):
        ...
        try:
            ...
            #
            self._create_plot_data_for_time_series(
                selectedparameter, analysisdata, self._plotdata
            )
            # Plot.
            graphtool.set_chart_selection(
                chart="Scatter chart", combined=True, stacked=False, y_log_scale=False
            )
    ...
    def _add_plot_2(self, subplot_only=False):
        ...
        try:
            ...
            #
            self._create_plot_data_for_seasonal_cycle(
                selectedparameter, analysisdata, self._plotdata
            )
            # Plot.
            graphtool.set_chart_selection(
    ...
    def _add_plot_3(self):
        ...
        try:
            ...
            # Plot.
            graphtool.set_chart_selection(
                chart="Bar chart", combined=True, stacked=False, y_log_scale=False
            )
    ...
    def _create_plot_data_for_seasonal_cycle(
        self, selectedparameter, dataset, plotdata
    ):
        """ """
        try:
            # Extract values for the plot.
                        ...
                        if parameter == selectedparameter:
                            ...
                            try:
                                ...
                                toolbox_utils.Logging().warning(
                                    "Float conversion (2) failed: Station: "
                                    + visit
                                    + " Taxon name: "
                                    + taxonname
                                    + " Parameter: "
            ...
            for taxonindex, taxon in enumerate(taxon_list):
                ...
                try:
                    ...
                    QtWidgets.QMessageBox.warning(
                        self._main_activity, "Warning", str(e)
                    )
            #
        except Exception as e:
            debug_info = (
