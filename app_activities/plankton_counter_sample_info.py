...
class PlanktonCounterSampleInfo(QtWidgets.QWidget):
    ...
    def _create_content_sample_info(self):
        ...
        self._sampler_type_code_list.addItems(
            [
                "<select or edit>",
                "HOS (Hose)",
        ...
        self._net_type_code_list.addItems(
            [
                "<select or edit>",
        ...
        gridrow = 0
        form1.addWidget(
            app_framework.LeftAlignedQLabel("<b>Sampling</b>"), gridrow, 0, 1, 1
        )
        form1.addWidget(
            app_framework.RightAlignedQLabel(""), gridrow, 1, 1, 10
        )  # Move the rest to left
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Sample name:"), gridrow, 0, 1, 1
        )
        form1.addWidget(self._sample_name_edit, gridrow, 1, 1, 2)
        form1.addWidget(self._change_sample_name_button, gridrow, 3, 1, 1)
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Sample id:"), gridrow, 0, 1, 1
        )
        form1.addWidget(self._sample_id_edit, gridrow, 1, 1, 3)
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Sampling: Year:"), gridrow, 0, 1, 1
        )
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("ICES metadata:"), gridrow, 0, 1, 1
        )
        hbox = QtWidgets.QHBoxLayout()
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Sampling laboratory:"), gridrow, 0, 1, 1
        )
        hbox = QtWidgets.QHBoxLayout()
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Project code:"), gridrow, 0, 1, 1
        )
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Method documentation:"), gridrow, 0, 1, 1
        )
        hbox = QtWidgets.QHBoxLayout()
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Station name:"), gridrow, 0, 1, 1
        )
        hbox = QtWidgets.QHBoxLayout()
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Latitude, degree:"), gridrow, 0, 1, 1
        )
        hbox = QtWidgets.QHBoxLayout()
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Latitude, decimal:"), gridrow, 0, 1, 1
        )
        hbox = QtWidgets.QHBoxLayout()
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Sampler type code:"), gridrow, 0, 1, 1
        )
        form1.addWidget(self._sampler_type_code_list, gridrow, 1, 1, 1)
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Sample min depth (m):"), gridrow, 0, 1, 1
        )
        hbox = QtWidgets.QHBoxLayout()
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Sampled volume (L):"), gridrow, 0, 1, 1
        )
        form1.addWidget(self._sampled_volume_l_edit, gridrow, 1, 1, 1)
        gridrow += 1
        form1.addWidget(
            app_framework.LeftAlignedQLabel("<b>Net sampling</b>"), gridrow, 0, 1, 1
        )
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Net type code:"), gridrow, 0, 1, 1
        )
        form1.addWidget(self._net_type_code_list, gridrow, 1, 1, 1)
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Sampler area (m2):"), gridrow, 0, 1, 1
        )
        hbox = QtWidgets.QHBoxLayout()
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.LeftAlignedQLabel("<b>Analysis</b>"), gridrow, 0, 1, 1
        )
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Analytical laboratory:"), gridrow, 0, 1, 1
        )
        form1.addWidget(self._analytical_laboratory_edit, gridrow, 1, 1, 3)
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Analysis. Year:"), gridrow, 0, 1, 1
        )
        hbox = QtWidgets.QHBoxLayout()
        ...
        gridrow += 1
        form1.addWidget(
            app_framework.RightAlignedQLabel("Analysed by:"), gridrow, 0, 1, 1
        )
            ...
            if dialog.exec():
                ...
                if new_sample_name:
                    ...
                    plankton_core.PlanktonCounterManager().rename_sample(
                        self._current_dataset, self._current_sample, new_sample_name
                    )
                    # Close dialog.
    ...
    def _from_fields_to_dict(self, metadata_dict):
        ...
        try:
            ...
            ] = app_framework.get_version()  # __version__
            ...
            metadata_dict["sampling_laboratory"] = str(
                self._sampling_laboratory_edit.text()
            )
            ...
            metadata_dict["method_documentation"] = str(
                self._method_documentation_edit.text()
            )
            metadata_dict["method_reference_code"] = str(
                self._method_reference_code_edit.text()
            )
            ...
            metadata_dict["sample_min_depth_m"] = str(
                self._sample_min_depth_m_edit.text()
            )
            metadata_dict["sample_max_depth_m"] = str(
                self._sample_max_depth_m_edit.text()
            )
            metadata_dict["water_depth_m"] = str(self._water_depth_m_edit.text())
            metadata_dict["sampler_type_code"] = str(
                self._sampler_type_code_list.currentText()
            )
            ...
            metadata_dict["analytical_laboratory"] = str(
                self._analytical_laboratory_edit.text()
            )
    ...
    def _from_dict_to_fields(self, metadata_dict):
        ...
        try:
            ...
            self._sampling_laboratory_edit.setText(
                metadata_dict.get("sampling_laboratory", "")
            )
            ...
            self._method_documentation_edit.setText(
                metadata_dict.get("method_documentation", "")
            )
            self._method_reference_code_edit.setText(
                metadata_dict.get("method_reference_code", "")
            )
            ...
            self._longitude_dd.setText(
                str(metadata_dict.get("sample_longitude_dd", ""))
            )
            #
            self._sample_min_depth_m_edit.setText(
                metadata_dict.get("sample_min_depth_m", "")
            )
            self._sample_max_depth_m_edit.setText(
                metadata_dict.get("sample_max_depth_m", "")
            )
            ...
            self._sampled_volume_l_edit.setText(
                metadata_dict.get("sampled_volume_l", "")
            )
            ...
            self._net_mesh_size_um_edit.setText(
                metadata_dict.get("net_mesh_size_um", "")
            )
            self._wire_angle_deg_edit.setText(metadata_dict.get("wire_angle_deg", ""))
            self._net_tow_length_m_edit.setText(
                metadata_dict.get("net_tow_length_m", "")
            )
            self._analytical_laboratory_edit.setText(
                metadata_dict.get("analytical_laboratory", "")
            )
    ...
    def _load_dataset_and_samples(self):
        ...
        try:
            ...
            for dataset in datasets:
                samples = plankton_core.PlanktonCounterManager().get_sample_names(
                    dataset
                )
