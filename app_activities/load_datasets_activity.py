...
#        contentLayout.addStretch(5)
    ...
    def _content_plankton_counter(self):
        ...
        self._counter_datasets_model = QtWidgets.QStandardItemModel()
        ...
        self._cleara_metadata_button.clicked(self._counter_uncheck_all_datasets)                
        self._markall_button = app_framework.ClickableQLabel('Mark all')
        self._markall_button.clicked(self._counter_check_all_datasets)                
        self._importcounterdataset_button = QtWidgets.QPushButton('Import marked dataset(s)')
        self._importcounterdataset_button.clicked(self._counter_import_counter_datasets)                
        # Layout widgets.
...
#                                        'Phytoplankton-archive (*.csv)'
        ...
        self._predefined_getdataset_button.clicked(self._import_predefined_datasets)                
        # Layout widgets.
...
#         introlabel.setText(help_texts.HelpTexts().getText('LoadDatasetsActivity_text_intro'))
        ...
        self._textfile_getdataset_button.clicked(self._load_text_files)                
        # Layout widgets.
        form1 = QtWidgets.QGridLayout()
        gridrow = 0
...
#         introlabel.setText(help_texts.HelpTexts().getText('LoadDatasetsActivity_excel_intro'))
        ...
        self._excel_getdataset_button.clicked(self._load_excel_file)                
        # Layout widgets.
        form1 = QtWidgets.QGridLayout()
        gridrow = 0
        label1 = QtWidgets.QLabel('Select parser:')
