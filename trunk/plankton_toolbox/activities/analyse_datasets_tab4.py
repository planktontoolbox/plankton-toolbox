...
#         self._lifestage_listview.setMaximumHeight(100)
        ...
        self.connect(clicklabel11, QtCore.SIGNAL("clicked()"), self._trophy_listview.uncheckAll)                
        self.connect(clicklabel12, QtCore.SIGNAL("clicked()"), self._trophy_listview.checkAll)                
        ...
        form1.addWidget(self._trophy_listview, gridrow, 16, 10, 3)
...
#         layout.addStretch(5)
    ...
    def _updateFilterAlternatives(self):
        ...
        for visitnode in analysisdata.getChildren():
            ...
            for samplenode in visitnode.getChildren():
                ...
                for variablenode in samplenode.getChildren():
                    ...
                    #
                    trophy_set.add(variablenode.getData(u'trophy'))
                    #
        ...
        self._trophy_listview.setList(sorted(trophy_set))
